...
SCALER_CONTAINER_PATH = "data/processed/scaler.pkl" # This path is correct if dvc pull works
...
def load_artifacts():
    ...
    try:
        ...
        logger.info(f"MLflow model '{MODEL_NAME}' with stage '{MODEL_STAGE}' loaded successfully.")
